...
public class JFrameMitreisendeGrid extends javax.swing.JFrame implements
		ActionListener {
	...
	private void initGUI() {
		try {
			...
			jLabelNamenPassagiere
					.setText("<html><body>Namen der<br>zusätzlichen Passagiere</body></html>");
			...
			if (JFrameNeueBuchung.mitreisende >= 1) {
				...
				jTextField1.setText(JFrameNeueBuchung.jTextFieldNachname
						.getText());

				jTextField11 = new JTextField();
				getContentPane().add(jTextField11);
				jTextField11.setText(JFrameNeueBuchung.jTextFieldVorname
						.getText());
			}
